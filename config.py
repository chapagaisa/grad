...
def get_arguments():
    ...
    parser.add_argument("--attack_mode", type=str, default="HiddenKiller", help="HiddenKiller, StyleBkd")
    ...
    parser.add_argument("--max_len", type=int, default=128, help="Maximum sequence length for BERT input")
